...
# ppo_expert.save(checkpoints_dir + "/PPO_CartPole")
ppo_expert = PPO.load(checkpoints_dir + "/PPO_CartPole")
...
# )
# a2c_student.save(checkpoints_dir + "/PPO_CartPole_Mimic")

a2c_student = A2C.load(checkpoints_dir + "/PPO_CartPole_Mimic")
